...
\begin{prooftree}
    \AxiomC{$\Gamma(x) = A$}
  \UnaryInfC{$\Term{\Gamma}{x}{\cty{E}{A}}$}
\end{prooftree}
\begin{prooftree}
    \AxiomC{$\Term{\Gamma,x : A}{M}{P}$}
  \UnaryInfC{$\Term{\Gamma}{\lam{x}{M}}{\cty{E}{(A \to P)}}$}
\end{prooftree}
\begin{prooftree}
    \AxiomC{$\Term{\Gamma}{N}{\cty{E}{(A \to \cty{E}{B})}}$}
    \AxiomC{$\Term{\Gamma}{M}{\cty{E}{A}}$}
  \BinaryInfC{$\Term{\Gamma}{\app{N}{M}}{\cty{E}{B}}$}
\end{prooftree}
\begin{prooftree}
    \AxiomC{$\typeof{k} = \kappa$}
  \UnaryInfC{$\Term{\Gamma}{k}{\kappa}$}
\end{prooftree}
\begin{prooftree}
    \AxiomC{$\typeof{\oplus} = \kappa \to \kappa^\prime \to \kappa^\dprime$}
    \AxiomC{$\Term{\Gamma}{M}{\kappa}$}
    \AxiomC{$\Term{\Gamma}{N}{\kappa^\prime}$}
  \TrinaryInfC{$\Term{\Gamma}{M \oplus N}{\kappa^\dprime}$}
\end{prooftree}
\begin{prooftree}
...
\end{prooftree}
\begin{prooftree}
    \AxiomC{$\llbracket k \oplus k^\prime \rrbracket = k^\dprime$}
    \RightLabel{$\delta$-\textsc{Red}}
  \UnaryInfC{$k \oplus k^\prime \stepto k^\dprime$}
\end{prooftree}
\begin{prooftree}
    \AxiomC{}
...
\end{prooftree}
\begin{prooftree}
    \AxiomC{$H = \fori{i}{n}{\treturn{x} \mapsto N, \perform{\effop_i}{x, k} \mapsto N_i}$}
