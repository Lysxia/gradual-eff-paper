...
\begin{figure}
\raggedright Value cast typing \fbox{$a : A \le A^\prime$}
\begin{prooftree}
    \AxiomC{}
...
\end{prooftree}
\raggedright Computation cast typing \fbox{$p : P \le P^\prime$}
\begin{prooftree}
    \AxiomC{$e : E \le E^\prime$}
    \AxiomC{$a : A \le A^\prime$}
  \BinaryInfC{$\cty{e}{a} : \cty{E}{A} \le \cty{E^\prime}{A^\prime}$}
\end{prooftree}
\raggedright Effect cast typing \fbox{$e : E \le E^\prime$}
\begin{prooftree}
    \AxiomC{}
