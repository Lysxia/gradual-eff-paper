...
\documentclass[\ClassReview acmsmall,sigplan,screen,prologue,dvipsnames,style=authoryear,anonymous]{acmart}
...
\Cref{types}~defines types and the precision relation on types.
