...
data _⊢_⇒ᶠ_∋_≤_ {Γ Γ′} (Γ≤ : Γ ≤ᴳ Γ′)
  ...
  cast≤ : ∀ {A B C} {A=>B : A =>ᶜ B} {B≤C : B ≤ᶜ C} {A≤C : A ≤ᶜ C} {𝐸 𝐸′}
    → commute≤ᶜ A=>B B≤C A≤C
    → Γ≤ ⊢ P≤ ⇒ᶠ A≤C ∋ 𝐸 ≤ 𝐸′
      --------------------------------------------
    → Γ≤ ⊢ P≤ ⇒ᶠ B≤C ∋ `cast A=>B [ 𝐸 ] ≤ 𝐸′

  ≤cast : ∀ {A B C} {A≤B : A ≤ᶜ B} {B=>C : B =>ᶜ C} {A≤C : A ≤ᶜ C} {𝐸 𝐸′}
    → ≤commuteᶜ A≤B B=>C A≤C
    → Γ≤ ⊢ P≤ ⇒ᶠ A≤B ∋ 𝐸 ≤ 𝐸′
      --------------------------------------------
    → Γ≤ ⊢ P≤ ⇒ᶠ A≤C ∋ 𝐸 ≤ `cast B=>C [ 𝐸′ ]
...
ren≤ᶠ ρ≤ (≤⇑ 𝐸≤) = ≤⇑ (ren≤ᶠ ρ≤ 𝐸≤)
ren≤ᶠ ρ≤ (cast≤ comm 𝐸≤) = cast≤ comm (ren≤ᶠ ρ≤ 𝐸≤)
ren≤ᶠ ρ≤ (≤cast comm 𝐸≤) = ≤cast comm (ren≤ᶠ ρ≤ 𝐸≤)
